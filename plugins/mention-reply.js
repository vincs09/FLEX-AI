    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "𝐅𝐋𝐄𝐗 𝐀𝐈 🥀",
            body: config.DESCRIPTION || "ENIGINE CORE BY 𝑨𝑳𝑳𝑨𝑵 𝑫𝑨𝑽𝑰𝑵𝑪𝑺 TECH 🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/a44m93.jpg", // Static image URL
            sourceUrl: "https://wa.me/message/255759637644",
